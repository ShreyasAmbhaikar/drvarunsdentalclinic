      ...
      <main className="bg-surface-container-lowest pt-[68px]">
        <section className="relative overflow-hidden bg-[#fff8ef]">
          ...
          <div className="relative mx-auto grid min-h-[520px] w-full max-w-[1360px] items-end gap-7 px-4 pb-8 pt-14 sm:px-6 md:px-14 lg:grid-cols-[minmax(0,1fr)_390px] lg:pb-12">
            <div className="w-full min-w-0 max-w-none pb-8 text-white sm:max-w-[380px] md:max-w-[850px]">
            ...
            <div className="w-full min-w-0 max-w-none overflow-hidden rounded-[28px] border border-white/18 bg-white/94 p-5 shadow-[0_24px_70px_rgba(37,20,6,0.22)] backdrop-blur-md">
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-[30px] border border-white bg-white p-3 shadow-[0_24px_70px_rgba(108,60,17,0.16)]">
                <Image
                  ...
                  width={900}
                  height={1120}
                  className="h-[340px] w-full rounded-[24px] object-cover md:h-[440px]"
